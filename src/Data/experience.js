const experience = [
  {
    company: "GSAP (GreenSock Animation Platform)",
    role: "Frontend Animation & UI Enhancements",
    duration: "Project Work - 2024",
    details: [
      "Implemented smooth and high-performance animations for UI elements.",
      "Created scroll-based effects and transitions to improve user engagement.",
  ...
  // },
  {
    ...
    duration: "Project Work - 2024",
    details: [
      "Designed gesture-based and fluid animations in React applications.",
      "Enhanced modals, sliders, and transitions for better user flow.",
      "Improved UI/UX consistency with reusable animation patterns.",
    ],
  },
  {
    company: "Locomotive Scroll & AOS",
    role: "Smooth Scrolling & Reveal Animations",
    duration: "Project Work - 2024",
    details: [
